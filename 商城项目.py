...
import random
ticket = int(random.randint(0, 40))
def w():
    if ticket >= 0 and ticket < 10:
        print("恭喜您抽到一张联想优惠券")
        return 1
    elif ticket >= 10 and ticket < 20:
        print("恭喜您抽到一张老干妈优惠券")
        return 2
    elif ticket >= 20 and ticket < 30:
        print("恭喜您抽到一张乌江榨菜优惠券")
        return 3

a=input("您是否需要一张优惠券Y/N：")
if a=="Y":
    n =w()
else:
    n =0
        ...
        if chose > len(shop):  # len(shop) = 7
            ...
            if money < shop[chose][1]:
                ...
                if n == 0:
                    ...
                    elif n==2 and chose==5:
                        money = money - shop[chose][1] * 0.6
                        print("恭喜，添加购物车成功！您的余额还剩：￥", money, "!")
                        n=0
                    elif n==3 and chose==6:
